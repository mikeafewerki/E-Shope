      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          ...
          <c:forEach var="slider" items="${sliders}">
					<li>
              <div class="seq-model">
                <img data-seq src="${slider.getUrl()}" width="200" height="200" alt="${slider.title }" />
              </div>
              <div class="seq-title">
...
<!--             <li> -->
<!--               <div class="seq-model"> -->
<%--                 <img data-seq src="<spring:url value='/resources/front/img/slider/2.jpg'></spring:url>" alt="Wristwatch slide img" /> --%>
<!--               </div> -->
<!--               <div class="seq-title"> -->
...
<!--             <li> -->
<!--               <div class="seq-model"> -->
<%--                 <img data-seq src="<spring:url value='/resources/front/img/slider/3.jpg'></spring:url>" alt="Women Jeans slide img" /> --%>
<!--               </div> -->
<!--               <div class="seq-title"> -->
...
<!--             <li> -->
<!--               <div class="seq-model"> -->
<%--                 <img data-seq src="<spring:url value='/resources/front/img/slider/4.jpg'></spring:url>" alt="Shoes slide img" /> --%>
<!--               </div> -->
<!--               <div class="seq-title"> -->
<!--                 <span data-seq>Save Up to 75% Off</span>                 -->
...
<!--              <li> -->
<!--               <div class="seq-model"> -->
<%--                 <img data-seq src="<spring:url value='/resources/front/img/slider/5.jpg'></spring:url>" alt="Male Female slide img" /> --%>
<!--               </div> -->
<!--               <div class="seq-title"> -->
              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="<spring:url value='/resources/front/img/promo-banner-1.jpg'></spring:url>" alt="img">                    
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<spring:url value='/resources/front/img/promo-banner-3.jpg'></spring:url>" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<spring:url value='/resources/front/img/promo-banner-2.jpg'></spring:url>" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sale Off</span>
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<spring:url value='/resources/front/img/promo-banner-4.jpg'></spring:url>" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="<spring:url value='/resources/front/img/promo-banner-5.jpg'></spring:url>" alt="img">                      
                      <div class="aa-prom-content">
                        <span>25% Off</span>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<spring:url value='/resources/front/img/man/polo-shirt-2.png'></spring:url>" alt="polo shirt img"></a>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<spring:url value='/resources/front/img/man/t-shirt-1.png'></spring:url>" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<spring:url value='/resources/front/img/man/polo-shirt-1.png'></spring:url>" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="<spring:url value='/resources/front/img/man/polo-shirt-4.png'></spring:url>" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="popular">
                  <ul class="aa-product-catg aa-popular-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="<script type="text/javascript" src="<spring:url value='/resources/front/'></spring:url>"></script>img/man/polo-shirt-2.png" alt="polo shirt img"></a>
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                         <figcaption>
                          <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                          <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
